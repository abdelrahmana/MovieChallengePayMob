package com.Movie.challenge.ui.fragment.search
...
import com.Movie.androidtask.data.model.Constants.QUERY
import com.Movie.androidtask.data.model.GridModel
...
import com.Movie.challenge.ui.fragment.moviefragment.InternetStatus
...
import com.Movie.challenge.ui.fragment.moviefragment.OnlineConnection
import com.Movie.challenge.ui.fragment.moviefragment.adaptor.AdaptorMovie
import com.Movie.challenge.util.NestedScrollPaginationView
  ...
  //  lateinit var interfaceImages: InterfaceImages // this interface will change depend on each selection
    ...
    private fun initValues() {
        ...
        adaptorMovie = AdaptorMovie(requireContext(),arrayListMovies,::onClickMovie){
            ...
            viewModel.updateMovieFavouriteUnfavourite(it)
        }
